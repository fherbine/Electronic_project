...
//    I2C1CONbits.ACKDT = 0;
//    I2C1CONbits.ACKEN = 0;
    IdleI2C1();//while (I2C1CONbits.PEN) ;
...
u8 I2C1_Receive_Data(u8 addr)
{
    ...
    IdleI2C1(); // TBF - Transmit Buffer Full
    data = MasterReadI2C1();
    Stop_I2CI();
    IdleI2C1(); // TBF - Transmit Buffer Full
    return data;
